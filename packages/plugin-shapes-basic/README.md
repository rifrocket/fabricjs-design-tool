<div align="center">
  ...
  **20 default shape object types for [Fabric Design Tool](../../README.md) — text, rects, ellipses, and 14 polygons.**
  ...
  [![npm](https://img.shields.io/npm/v/%40rifrocket%2Ffdt-plugin-shapes-basic/alpha.svg)](https://www.npmjs.com/package/@rifrocket/fdt-plugin-shapes-basic)
...
Depends on `@rifrocket/fdt-core` and `@rifrocket/fdt-properties`.
